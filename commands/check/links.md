...
### Two-Step Validation Process[​](#two-step-validation-process "Direct link to Two-Step Validation Process")
...
### Link Extraction[​](#link-extraction "Direct link to Link Extraction")
...
### Validation Process[​](#validation-process "Direct link to Validation Process")
...
## Report Formats[​](#report-formats "Direct link to Report Formats")
...
### JSON Report Structure[​](#json-report-structure "Direct link to JSON Report Structure")
...
See [Fix Links](/commands/fix/links.md) for more details on auto-fixing.
