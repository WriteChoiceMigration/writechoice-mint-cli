...
## Supported Item Types[​](#supported-item-types "Direct link to Supported Item Types")
...
### Autogenerated expansion[​](#autogenerated-expansion "Direct link to Autogenerated expansion")
...
## Example Input → Output[​](#example-input--output "Direct link to Example Input → Output")
