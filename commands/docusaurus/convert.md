...
### Admonitions → Mintlify callout components[​](#admonitions--mintlify-callout-components "Direct link to Admonitions → Mintlify callout components")
...
### Tabs → Mintlify Tabs[​](#tabs--mintlify-tabs "Direct link to Tabs → Mintlify Tabs")
...
### Accordions → Mintlify Accordion[​](#accordions--mintlify-accordion "Direct link to Accordions → Mintlify Accordion")
...
### H1 reconciliation with frontmatter[​](#h1-reconciliation-with-frontmatter "Direct link to H1 reconciliation with frontmatter")
...
### Frontmatter key renames[​](#frontmatter-key-renames "Direct link to Frontmatter key renames")
...
### Theme imports removed[​](#theme-imports-removed "Direct link to Theme imports removed")
...
### Internal links — extensions stripped[​](#internal-links--extensions-stripped "Direct link to Internal links — extensions stripped")
...
### Images — paths converted and wrapped in `<Frame>`[​](#images--paths-converted-and-wrapped-in-frame "Direct link to images--paths-converted-and-wrapped-in-frame")
...
### Snippets — `_`-prefixed files routed to `snippets/`[​](#snippets--_-prefixed-files-routed-to-snippets "Direct link to snippets--_-prefixed-files-routed-to-snippets")
...
### HTML comments → JSX comments[​](#html-comments--jsx-comments "Direct link to HTML comments → JSX comments")
