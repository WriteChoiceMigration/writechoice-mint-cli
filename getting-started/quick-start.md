...
## 2. Create a config file[​](#2-create-a-config-file "Direct link to 2. Create a config file")
...
## 3. Validate MDX parsing[​](#3-validate-mdx-parsing "Direct link to 3. Validate MDX parsing")
...
## 4. Validate links[​](#4-validate-links "Direct link to 4. Validate links")
...
## 5. Explore other commands[​](#5-explore-other-commands "Direct link to 5. Explore other commands")
